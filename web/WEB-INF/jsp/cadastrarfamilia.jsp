            ...
            <div> 
                <form action="cadastrarFamilia" method="POST" >
                    ...
                    <div class="form-group">  
                        ...
                        <input type="text" name="cep" id="cep" class="form-control cep"  placeholder="Qual o CEP, código de endereçamento postal, da Família?">
                     ...
                     <div class="form-group"> 
                        ...
                        <input type="text" name="telefone_fixo" id="telefone_fixo " class="form-control phone"  placeholder="Qual o Número de Telefone Principal da Família?">
                    ...
                    <div class="form-group">  
                        <label for="comodos_moradia">Cômodos da Moradia</label>                          
                        </br>
                     ...
                     <div class="form-group"> 
                        <label for="condicoes_moradia">Condições da Moradia</label> 
                        </br>
